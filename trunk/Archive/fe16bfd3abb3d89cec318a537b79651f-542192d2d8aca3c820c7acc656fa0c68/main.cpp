...
int main() {
    std::string one = "unsigned two_way(const std::string& one, const std::string& two, const std::string& three);";
    std::string two = "unsigned two_way(const std::string& one, const std::string& two, const std::string& three)";
    std::string three = "a";
