...
struct _apply {
  ...
  static inline auto _(F&& f, T&& t, A&&... a)
    -> decltype(_apply<N-1>::_(::std::forward<F>(f), ::std::forward<T>(t), ::std::get<N-1>(::std::forward<T>(t)), ::std::forward<A>(a)...))
  {
...
inline auto apply(F&& f, T&& t)
  -> decltype(impl::_apply< ::std::tuple_size<typename ::std::decay<T>::type>::value>::_(::std::forward<F>(f), ::std::forward<T>(t)))
{
