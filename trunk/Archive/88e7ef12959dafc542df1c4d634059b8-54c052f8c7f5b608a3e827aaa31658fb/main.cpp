...
#define MAP_FIRST (Fields, GenSep) FIRST (HEAD(Fields)) EACH(FIRST_,  GenSep, TAIL(Fields))
#define MAP_SECOND(Fields, GenSep) SECOND(HEAD(Fields)) EACH(SECOND_, GenSep, TAIL(Fields))    
