...
template<class OPTIMIZER,class DenseMatrix>
void TransportationSolver<OPTIMIZER,DenseMatrix>::_checkCounter (size_t* pcounter, const char* errmess)
{
...
template<class OPTIMIZER,class DenseMatrix>
void TransportationSolver<OPTIMIZER,DenseMatrix>::_InitBasicSolution(const UnaryDense& xarr,const UnaryDense& yarr)
{
	UnaryDense row=xarr;
	UnaryDense col=yarr;
