...
template<typename T, typename ...Hooks> // template<typename> class HookPolicy
struct Wrap
{
    template<typename ...Args>
    explicit Wrap(Args && ...inArgs) : Group<Hooks...>::Rebind, mObject(std::forward<Args>(inArgs)...) { }
...
int main()
{
    ...
    typedef Wrap<std::string, TextDecoration, Timer, MutexLock, Inspect> String;
