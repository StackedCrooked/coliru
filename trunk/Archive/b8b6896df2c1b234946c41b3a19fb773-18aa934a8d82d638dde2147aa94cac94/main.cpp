...
boost::optional<myint> ctor(int arg) {return myint(arg);}
boost::optional<myint> ctor(boost::none_t arg) {return arg;}
...
struct myclass {
    ...
    :content0(ctor(a0)), content1(ctor(a1)), content2(ctor(a2))
    {}
};
