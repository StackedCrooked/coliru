...
public:
    ...
    lex::token_def<lex::omit>   paren_open, paren_close, comma, semi_colon;
    ...
    sql_tokens()
    {
        ...
        this->self += paren_open | paren_close | comma | semi_colon;
...
#endif
{
        ...
        : sql_grammar::base_type(program, "program")
    {
        ...
        primary_key_constraint
            = tok.kw_primary_key >> tok.paren_open >> (tok.identifier % tok.comma) >> tok.paren_close
            ;
