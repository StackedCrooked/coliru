...
ast::expression* build_integer_constant_expression(const char* c)
{
    return nullptr;
}
...
struct strip_comments_tokens : lex::lexer<Lexer>
{
      ...
      : strip_comments_tokens::base_type(lex::match_flags::match_default)
    {
        ...
        this->self.add
            ...
            (right_paren, RIGHT_PAREN) (plus, PLUS)
            (minus, MINUS)
...
struct strip_comments_grammar : qi::grammar<Iterator, ast::expression*()>
{
      ...
      : strip_comments_grammar::base_type(start)
    {
        ...
        expression = (term >> tok.plus  >> term) [ qi::_val = qi::_1 ] // [ qi::_val = build_binop_expression_(qi::_1, new ast::binop_plus(), qi::_3) ]
                   | (term >> tok.minus >> term) [ qi::_val = qi::_1 ] // [ qi::_val = build_binop_expression_(qi::_1, new ast::binop_minus(), qi::_3) ]
                   | term                        [ qi::_val = qi::_1 ]
                   ;

        term = (factor >> tok.multiplication >> factor)   [ qi::_val = qi::_1 ] // [ qi::_val = build_binop_expression_(qi::_1, new ast::binop_times(), qi::_3) ]
             | (factor >> tok.division       >> factor)   [ qi::_val = qi::_1 ] // [ qi::_val = build_binop_expression_(qi::_1, new ast::binop_divide(), qi::_3) ]
        ...
        plus_factor = tok.number                        [ qi::_val = build_integer_constant_expression_("LOL") ]
                    //| (tok.left_paren >> expression >> tok.right_paren) [ qi::_val = qi::_2 ]
                    ;
    }
...
int main(int argc, char* argv[])
{
    ...
    // lexer type
    typedef 
        lex::lexertl::lexer<lex::lexertl::token<base_iterator_type,boost::mpl::vector<char> > > //you need to add an mpl::vector of the types of the attributes that your lexer exposes ( in this case simply char )
    lexer_type;
