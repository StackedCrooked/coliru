...
template<class node, class allocator, class value_type>
std::unique_ptr<node,alloc_aware<allocator>> allocate_new_node(allocator& alloc, const value_type& value) {
