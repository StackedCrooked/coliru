...
int main() {
    ...
    assert(CanTypeFitValueOrig<signed long long>(ULLONG_MAX) == false);    
    assert(CanTypeFitValueOrig<unsigned long long>(LLONG_MIN) == false);
    assert(CanTypeFitValueOrig<unsigned long long>(-1) == false);
}
