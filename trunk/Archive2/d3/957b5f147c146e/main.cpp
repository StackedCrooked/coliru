...
void quick_sort(FwdIt first, FwdIt last, Compare cmp = Compare{})
{
    ...
    std::partition(first, last, [=](auto const& value){ return value < *pivot; });
...
{                                                                           \
    std::for_each(first, last, [](auto t) {                                 \
        ...
        std::cout << std::boolalpha << is_sorted(begin(t), end(t)) << ",";  \
    });                                                                     \
    std::cout << "\n";                                                      \
}   
...
int main()
{
    ...
    std::vector<int> inputs[] = { random, sorted, reversed, nearly_sorted, few_unique };
