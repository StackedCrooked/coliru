  ...
  class Camera
  {
    ...
    {}
      ...
      //! \}
        ...
        //Retourne la temperature interne de la caméra.
      ...
      private std::pair<Camera, Camera>
  {
    ...
    enum class TemperatureSensor
    {
      ...
      std::map<TemperatureSensor, Temperature> temperature() const
      {
        ...
        output[TemperatureSensor::CameraLeft] = this->first.temperature();
        output[TemperatureSensor::CameraRight] = this->second.temperature();
