    ...
    struct parser : qi::grammar<It, expr(), Skipper>
{
    parser() : parser::base_type(expr_)
    {
        ...
        prod_ = (factor_ >> "." >> prod_)  [ _val = phx::construct<binop<op_prod> >(_1, _2) ] | factor_ [_val = _1];
        seq_  = ("Seq" > var_     )   [ _val = phx::construct<unop <op_seq>  >(_1)     ]; 
	    atom_ = ("Z" > arg_         )   [ _val = phx::construct<unop <op_atom> >(_1)     ] ;
	    eps_  = lit("E" ) /*CHANGED*/                 [ _val = phx::construct<symb <symb_epsilon> >()/*CHANGED*/    ] ;
        
        var_ = qi::lexeme[ +alpha ];
        arg_ = '(' > int_ > ')';
        
        factor_ = ( '(' > sum_ > ')' ) | seq_ | atom_ | eps_ | var_;
  ...
  qi::rule<It, expr(), Skipper> expr_, rule_, sum_, prod_, seq_, atom_, eps_, simple_, factor_;
  qi::rule<It, int(),Skipper> arg_;
};
