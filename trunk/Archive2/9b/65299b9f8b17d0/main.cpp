...
struct A : crtp_helper<A,base> { protected: virtual const base& do_get() const override = 0 ; };
struct B : crtp_helper<B,base> { protected: virtual const base& do_get() const override = 0 ; };
struct AB : crtp_helper<AB,A,B> { protected: virtual const base& do_get() const override = 0 ; };
