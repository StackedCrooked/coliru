...
int main(){
    ...
    sentence.emplace_back("gatti");
    sentence.emplace_back("e");
    sentence.emplace_back("cani");
    sentence.emplace_back("sono");
    sentence.emplace_back("amici");
    sentence.emplace_back("di");
    sentence.emplace_back("uomini");
    sentence.emplace_back("e");
    sentence.emplace_back("donne");
    //sentence.emplace_back(".");
    Rules rules;
    rules.emplace_back(DummyRule(0, 2));
    rules.emplace_back(DummyRule(6, 8));
