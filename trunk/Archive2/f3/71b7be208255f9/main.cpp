...
union fizz_buzz_item_holder
{
    fizz_buzz_item_holder(fizz_buzz_items::fizz fizz) : fizz{fizz} {}
    fizz_buzz_item_holder(fizz_buzz_items::buzz buzz) : buzz{buzz} {}
    fizz_buzz_item_holder(fizz_buzz_items::fizz_buzz fizz_buzz) : fizz_buzz{fizz_buzz} {}
    fizz_buzz_item_holder(fizz_buzz_items::number number) : number{number} {}
