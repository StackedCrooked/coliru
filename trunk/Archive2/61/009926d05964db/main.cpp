...
template <int N, typename T, typename... Ts> auto& get(tuple<T, Ts...>& t, typename enable<N == 0>::type* = nullptr) { return t.head; }
template <int N, typename T, typename... Ts> auto& get(tuple<T, Ts...>& t, typename enable<N != 0>::type* = nullptr) { return get<N-1>(static_cast<tuple<Ts...>&>(t)); }
