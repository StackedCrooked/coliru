...
int main()
{
    ...
    for(size_t idy = 0; idy < greatest_size; ++idy)
    {
        ...
        cout << v1[idy] << " + " << v2[idy] << " = " << datsumdoe[idy] << endl;     //Ooh, you might be interested in how this makes the output appear the way it does?
    }                                                                               //It will probably be easy to figure out, tho
}