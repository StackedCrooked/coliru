...
g++ -O2 -std=c++11 -pedantic -Wall -Wextra -Wconversion -Wsystem-headers -pthread main.cpp && ./a.out
# clang++ -O2 -std=c++11 -Wall -Wextra -pedantic -pthread main.cpp && ./a.out
# clang++ -O2 -stdlib=libc++ -std=c++11 -Wall -Wextra -Wconversion -pedantic -pthread main.cpp -lcxxrt -ldl && ./a.out
