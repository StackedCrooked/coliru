...
{ static constexpr result<T> select( T v ) { return v ; } };

template < typename FIRST, typename... REST >
struct type_selector<FIRST, REST...> : type_selector<FIRST>, type_selector<REST...>
{
    static constexpr result<FIRST> select( FIRST v )
    { return type_selector<FIRST>::select(v) ; }

    template < typename T > static constexpr result<T> select( T v )
    { return type_selector<REST...>::select(v) ; }
};
