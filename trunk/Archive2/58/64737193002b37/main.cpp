...
struct ParseGrammar: public qi::grammar<Iterator, ast::SourceCode(), Skipper>
{
        ...
        annotate(first)
    {
        ...
        on_success(Identifier,    annotate(_val, _1, _3) );
        on_success(VarAssignment, annotate(_val, _1, _3) );
        on_success(SourceCode,    annotate(_val, _1, _3) );
        
        //This one would be more faithful to the original but BOOST_AUTO seems a little clunky
        //and the real type is really scary
        //
        //BOOST_AUTO( set_location_info , annotate(_val, _1, _3) );
