...
struct Parser : qi::grammar<It, ast::Equation(), Skipper>
{
    ...
    qi::rule<It, ast::Constant()> constant_; // Constant character a - e
    qi::rule<It, ast::Function()> function_; // Function character f - r
    qi::rule<It, ast::Variable()> variable_; // Variable character s - z

    qi::rule<It, ast::FunctionCall(), Skipper> function_call; // Allows for basic function parsing eg. f(x, y, z)
