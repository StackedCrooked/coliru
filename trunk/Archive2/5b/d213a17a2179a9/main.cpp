    ...
    void twoArgHandler(int a, int b)
    {
        std::cout << "twoArgHandler:  param1: " << a << " param2: " << b << std::endl;
    }
    
    void oneArgHandler(int a)
    {
        std::cout << "twoArgHandler:  param: " << a << std::endl;
    }
    
    void noArgHandler()
    {
        std::cout << "noArgHandler: no params to show :(" << std::endl;
    }