...
struct interlace_impl<std::tuple<r...>, N, i, std::tuple<packs...>> :
    interlace_impl<std::tuple<r..., typename get_elem<i, packs>::type...>, N, i+1, std::tuple<packs...>> {};
template <typename... r, std::size_t N, typename ... packs>
struct interlace_impl<std::tuple<r...>, N, N, std::tuple<packs...>> :
    clean<std::tuple<>, r...> {};
    
template <typename... packs> 
using sizeof_largest = std::integral_constant<std::size_t, std::max({sizeof_pack<packs>::value...})>;
template <typename ... packs>
using interlace = interlace_impl<std::tuple<>, sizeof_largest<packs...>{}, 0, std::tuple<packs...>>;
