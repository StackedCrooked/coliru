...
struct tseitin : boost::static_visitor<void> {
  ...
  private:
    template <typename T, typename U> void recurse(T const &v, U p) const {
        boost::apply_visitor(boost::bind(*this, _1, p), v);
    }
};
    ...
    struct parser : qi::grammar<It, expr(), Skipper>
{
    parser() : parser::base_type(expr_)
    {
        ...
        impl_= (or_ >> "=>" >> impl_)   [ _val = phx::construct<binop<op_impl>>(qi::_1,qi::_2) ] | or_    [ _val = qi::_1 ];
        ...
        simple = (('(' > expr_ > ')') | var_);
        //  var_ = *as_string[qi::lexeme[ +digit ]] [if_(phx::ref(m) < qi::_1) [phx::ref(m) = qi::_1], _val = qi::_1]; // qi::lexeme[ +digit ] [count++];//lexeme[ +alpha ];
        var_ = int_ [_val = qi::_1, if_(phx::ref(m) < qi::_1) [phx::ref(m) = qi::_1]];
    }
