##clang++ --version
##g++ --version
##set -x ; g++-4.8 -std=c++11 -Wall -Wextra -Wconversion -pedantic -O3 -pthread main.cpp && ./a.out
##g++ --version
...
##set -x ; clang -x c -std=c99 -fsanitize=undefined,address -Wall -Wextra -Wconversion -Weverything  -O0  -pedantic main.cpp && ./a.out