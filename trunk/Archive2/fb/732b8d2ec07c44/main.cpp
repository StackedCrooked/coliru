...
int main ( int argc, char *argv[] )
{
	...
	test.append( reinterpret_cast<char *>(&i), sizeof(int));
	test.append( "[0][1][2][3][4][5][6][7]" );
    test.append( reinterpret_cast<char *>(&k), sizeof(long));
	test.append( "[0][1][2][3][4][5][6][7]" );
	...
	//l = *((long *)( &test[28]));
	memcpy(&j, (void *)&test[0], sizeof(j));
	memcpy(&l, (void *)&test[28], sizeof(l));
