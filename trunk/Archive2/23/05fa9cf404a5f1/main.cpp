...
double MatrixDeterminant( const Matrix& mat )
{
    ...
    for( unsigned int i = 0; i < mat.columns; i++ )
    {
        ...
        cout << "mat dimensions: " << mat.rows << "x" << mat.columns << endl;
        cout << "Minor dimensions: " << _minor.rows << "x" << _minor.columns << endl;
        ...
        for( unsigned int j = 0; j < mat.rows; j++ )
        {
            ...
            {   
                if( ( j != 0 ) && ( k != i ) )
                {
                    ...
                    cout << "Indices: " << rowIndex << ", " << colIndex << endl;
                    
                    _minor( rowIndex, colIndex ) = mat( j, k );
                    cout << "copied: " << _minor( rowIndex, colIndex ) << endl;
                    colIndex++;
