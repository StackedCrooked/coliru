...
{
    void testGo(void);
    void test8(void); void test7(void); void test6(void); void test5(void); void test4(void); void test3(void); void test2(int&); void test1(void); template<typename A> void dumpMapReverse(const A &map);
}
...
namespace local
{
    ...
    public:
        ...
        Me& operator=(const Me& input)                  { cout << "copy assignment.: " << mine_ << "\tfrom: " << input.mine_ << endl; }
        Me& operator=(Me&& input)                       { cout << "move assignment.: " << mine_ << "\tfrom: " << input.mine_ << endl; }
