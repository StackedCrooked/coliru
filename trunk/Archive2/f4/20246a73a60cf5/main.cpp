...
{    
    ...
    std::vector<SLDBConfigParams> parameterInfo = {
        ...
        SLDBConfigParams("drname2._dr", "nic1", PriorityLevel(1, 'B', 3)),
        SLDBConfigParams("drname2._dr", "nic1", PriorityLevel(1, 'B', 4)),
        SLDBConfigParams("drname2._dr", "nic1", PriorityLevel(1, 'B', 5)),
...
#if 1
        std::cout << "channel [" << iter->getChannel() << "] priorities - unordered" << std::endl;
