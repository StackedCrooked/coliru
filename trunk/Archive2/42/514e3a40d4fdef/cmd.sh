...
##g++ --version
##g++-4.8 --version2set -x ;
##g++-4.9 -std=c++11  -Warray-bounds  -Wunreachable-code -Wall -Wextra -Wconversion -pedantic  -O3 -pthread  main.cpp && ./a.out 
##g++ --version
##set -x ; g++-4.9 -std=c++11 -Wall -Wextra -Wconversion -pedantic  -O3  -pedantic  -pthread -S main.cpp && cat main.cpp 
set -x ; clang++  -std=c++11 -Wunreachable-code -fsanitize=undefined,signed-integer-overflow  -O3 -Wall -Wextra -Wconversion  -pedantic -Wall -pthread  main.cpp && ./a.out 
