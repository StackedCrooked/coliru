...
##c++filt -t d
##gcc -x c -std=c99  -O1 -Wc++-compat -W -Wall -Wextra -Wconversion -pedantic  -fno-builtin  main.cpp -pthread -lm && ./a.out
...
##clang -x c -std=c99  -W -Wall -Wextra -Weverything -pedantic -O3 main.cpp && ./a.out
