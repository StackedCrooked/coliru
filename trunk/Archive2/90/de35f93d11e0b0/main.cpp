...
From my understanding, we now exit the if statement and move to line 28, where 
num (with a value of 9) is printed again. Therefore, I understand why the output 
of the program is 1,2,3,4,5,6,7,8,9,9  - but I do not understand why we then have
8,7,6,5,4,3,2,1. 
