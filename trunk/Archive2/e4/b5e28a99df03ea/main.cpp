...
private:
    ...
    { assert(valid()); return static_cast<const Base&>(static_cast<const BaseHelper&>(storage)); }

    Base& base()
    { assert(valid()); return static_cast<Base&>(static_cast<BaseHelper&>(storage)); }
