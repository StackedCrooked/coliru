...
namespace client { namespace parser
{
    ...
    struct expression : qi::grammar<Iterator, ast::expression(), qi::space_type >
    {
        expression()
        : expression::base_type(expr)
	{
        ...
        qi::rule<Iterator, ast::expression(), qi::space_type >
        ...
        qi::rule<Iterator, std::list<ast::expression>(), qi::space_type >
            argument_list
            ;
