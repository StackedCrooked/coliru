...
int main()
{
    ...
    std::cout << "char == unsigned char: " << std::is_same<int, unsigned int>::value << '\n';   // true
    std::cout << "char == signed char: " << std::is_same<int, signed int>::value << '\n';   // false
    std::cout << "char is signed: " << std::is_signed<int>::value << '\n'; // false   
