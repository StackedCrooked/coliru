...
struct IndexOf_<El, Tuple, Index, Index>
{
...
struct IsAnyOf<T, argument_type>
...
template<typename Head, typename Tail>
struct HasDuplicates<Head, Tail>
...
struct HasDuplicates<Head, Next, Tail...>
...
{
    typedef T Arg_type;
    explicit StrongTypedef(const T& t = T()) : t(t)
    {
    }
