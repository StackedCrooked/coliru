...
{
    return memcmp(&a1.m_Address, &a2.m_Address,sizeof(in6_address)) == 0;
}

/// Compare addresses for ordering.
friend bool operator<(const IpAddress& a1,const IpAddress& a2)
{
  	return a1.m_Address.in6_u.u6_addr32[0] < a2.m_Address.in6_u.u6_addr32[0];
...
{
    public:
        int operator()(const std::pair<IpAddress,IpAddress>& lhs, const std::pair<IpAddress,IpAddress>& rhs)
        {
            return lhs.second < rhs.second;
        }
};

class CustomComparitorHash
{
    public:
        std::size_t operator()(const std::pair<IpAddress,IpAddress>& lhs)const
        {
            return 42;
        }
};
...
int main()
{
    ...
    boost::unordered_set< std::pair<IpAddress, IpAddress> , CustomComparitorHash > myset;
    ...
    if(a<b)
        ...
        myset.insert(std::make_pair(b,a));
