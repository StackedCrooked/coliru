...
// 2014 April 5;  Aurthor : Mr Lam/ Yee Din(林貽典)  Email: yeedlam@yahoo.com
...
for (m = 0; m - 1 < 90; m ++)
{
  ...
  double  Center_Y_extra = Center_Y + 0.1563 - Sun_arc/590.0825;  //suppose modified by 邢雲路
  ...
  double  Sun_Lat = Sun_Y + Sun_S_arcDiff;     //   以加黄赤道半背弦，即為黄赤道內外半弧背(Sun_Lat)
          Sun_Lat = sqrt(d*SY_b) + Sun_S_arcDiff/3.0;
