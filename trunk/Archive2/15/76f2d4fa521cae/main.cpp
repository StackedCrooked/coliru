...
template<class mytype>
mytype OrderedList<mytype>::get(int pos)
{
    return list[pos];
}
...
public:
     ...
     * Postcondition: 
     */
    friend OrderedList<mytype> operator+  (const OrderedList<mytype>& a, const OrderedList<mytype>& b);
    /**
     * Precondition:
     * Postcondition: 
     */
    friend std::ostream& operator<< <mytype>(std::ostream& out, const OrderedList<mytype>&);
