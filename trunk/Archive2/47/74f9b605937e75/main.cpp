    ...
    struct calculator : qi::grammar<Iterator, ast::expression(), ascii::space_type>
    {
        calculator() : calculator::base_type(expression)
        {
            ...
            BOOST_SPIRIT_DEBUG_NODES(
                (expression)(term)(factor)(exp_elem)); //MODIFIED
		...
		qi::rule<Iterator, ast::expression(), ascii::space_type> factor; //ADDED
        qi::rule<Iterator, ast::operand(), ascii::space_type> exp_elem; //MODIFIED
    };
}
