...
inline bool operator== ( const Char& a, const Char& b ) { return std::addressof(a) == std::addressof(b) ; }
inline bool operator!= ( const Char& a, const Char& b ) { return !(a==b) ; }

inline bool operator== ( const Char& a, const char& b ) { return std::addressof(a.value) == std::addressof(b) ; }
inline bool operator!= ( const Char& a, const char& b ) { return !(a==b) ; }

inline bool operator== ( const char& a, const Char& b ) { return b == a ; }
inline bool operator!= ( const char& a, const Char& b ) { return !(a==b) ; }
