...
namespace client
{
    ...
    struct calculator : qi::grammar<Iterator, ascii::space_type, spirit::utree()>
    {
        ...
        qi::rule<Iterator, ascii::space_type, spirit::utree()> expr, term, factor, number, digit, sign;
    };
}
...
{
    std::cout << "/////////////////////////////////////////////////////////\n\n";
    std::cout << "expr parser...\n\n";
    std::cout << "/////////////////////////////////////////////////////////\n\n";
    std::cout << "Type an expr...or [q or Q] to quit\n\n";
    ...
    std::string str = "11+12/(23*3+11)-2*1/4";
