...
//                                           下廉           益從方          正實
//                               (b*b*b*b)  - 6*a*d*(b*b) - 9*d*d*d*(b) + 9*a*a*d*d = 0         四庫全書(787册/730頁) 古今律曆考卷六十九     
// 2014 April 30;  Aurthor : Mr Lam/ Yee Din(林貽典)  Email: yeedlam@yahoo.com
...
const double  Sun_Y24Ref = 23.7785;        //    23.7785 from page(787-729);  23.8070 from page(787-717) 
...
for (m = 0; m - 1 < 90; m ++)
{
  ...
  //______________________________________________________________________________________________________________
          Center_W = Center_W + 0.000528*Sun_arc;     // suppose modeified by 邢雲路
                                                      // to adjust for S_arc360 to be close to 0 when deg360 = 90
  //______________________________________________________________________________________________________________
  ...
  //______________________________________________________________________________________________________________________________________
          Center_Y = Center_Y+0.0016949*(91.314375 + 0.91540063 - Sun_arc); // suppose modified by 邢雲路 
                                                                            // to adjust for Sun_Lat360 to be close to 90 when deg360 = 90 
