...
int main()
{
  const int equipNum=100000; //number of equips simulated - for 13: set to 5000, for 14 set to 1000 for 15 set to 200 else face the wrath of your processor
 ...
 std::uniform_real_distribution<double> gen(0.0, 1.0);
  ...
  std::cout << "Average Total Cost to go from " << a << "stars to " << desiredStars << ": " << std::setprecision(18) << std::setw(24) << averagecost << " mesos\n";
