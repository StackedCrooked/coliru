...
template <std::size_t depth, typename ... First, std::size_t... indices>
template <std::size_t index, std::size_t ... type_indices>
void(*const create_lookup<depth, std::tuple<First...>, index_list<indices...>>::get_ptr<index, index_list<type_indices...>>::value)() = work< typename std::tuple_element<index / ipow(length, depth-type_indices-1) % length, std::tuple<First...>>::type... >;
