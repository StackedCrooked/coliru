...
int main()
{
...

    {
        ...
        // end of full expression: temporary object A{ "ijkl" } destroyed

    } // end of lifetime of reference efgh: temporary object A{ "efgh" } destroyed
...
} // end of lifetime of reference mnop: temporary object A{ "mnop" } destroyed
  // end of lifetime of reference abcd: temporary object A{ "abcd" } destroyed
