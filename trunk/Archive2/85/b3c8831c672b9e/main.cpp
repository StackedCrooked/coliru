...
#define LOOP_DELIM_0( A, DELIM, B )
#define LOOP_DELIM_1( A, DELIM, B ) A##1 DELIM B##1
#define LOOP_DELIM_2( A, DELIM, B ) LOOP_DELIM_1( A, DELIM, B ), A##2 DELIM B##2
#define LOOP_DELIM_3( A, DELIM, B ) LOOP_DELIM_2( A, DELIM, B ), A##3 DELIM B##3

#define LOOP_DELIM( A, DELIM, B, N ) LOOP_DELIM_##N( A, DELIM, B )

#define FUNC( N ) \
    void func( LOOP( int a, N ) ) \
	{ \
	int LOOP_DELIM( b, =, a, N ); \
	}
