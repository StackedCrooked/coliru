...
struct insert_counter : public std::iterator<std::output_iterator_tag,
                                             void, void, void, void>
{
    std::size_t counter = 0;
    
    template<typename T>
    insert_counter& operator=(T const&)
    {
        ++counter;
        return *this;
    }
    
    insert_counter& operator*() { return *this; }
    insert_counter& operator++() { return *this; }
    insert_counter& operator++(int) { return *this; }
};
