...
struct centre
{
    ...
    template < typename T > void put( T&& v ) { stm << v ; }

    template < typename FIRST, typename... REST >
    void put( FIRST&&  first, REST&&... rest ) { stm << first ; put(rest...) ; }
...
int main()
{
    std::cout << "    |" << centre( 40, "hello world" ) << "|\n"
               ...
               << "    |" << centre( 40, "first value: ", std::fixed,
                                     std::setprecision(2), 6.7 ) << "|\n"

               << "    |" << centre( 40, "the second value is: ", std::setw(6),
                                     std::internal, std::setfill('0'), -123 ) << "|\n" ;
}
