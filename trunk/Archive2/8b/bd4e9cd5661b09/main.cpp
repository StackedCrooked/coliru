...
namespace metaAdd{
    ...
    using find_indices =  typename  meta::accumulate< List, 
                                                      details::find_ind_state< meta::list<> , 0 >, /* accumulate the index list and the current index of the element*/
...
int main()
{
    std::tuple<int,double,float, int> a{1,2,3,4};
    
    //TupleVisit::visit(vis{},a);
    
    TupleVisit::visit<>(vis{},a);
    //TupleVisit::visit<int,float,float,int>(vis{},a);
   
   using l = meta::list<int,double,int,double, int, int , int>;
    
    metaAdd::find_indices<int,l>::as;
