...
int main() {
	Cookies("Softkekse", 0.5, 3, false);
	Cookies("Schoko-Doppelkekse", 0.5, 3, false);
	Product("Lebkuchen", 0.5, 3, false);
	Biscuits("Hazelnut Biscuits", 0.5, 3, false);
	Biscuits("Vanilla Biscuits", 0.5, 3, false);
	Biscuits("Shoco Biscuits", 0.5, 3, false);
