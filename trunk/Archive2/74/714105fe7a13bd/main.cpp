...
template < typename T > struct matrix
{
    ...
    matrix( matrix<T>&& that ) noexcept( std::is_nothrow_move_constructible< std::vector<T> >::value ) = default ; // defaulted move constructor
...
int main()
{
    std::cout << "/////////////////////////////////////////////////////////////////////////////////\n"
              ...
              << "is vector<T> nothrow_move_constructible if T is nothrow_move_constructible? " << std::boolalpha
              << std::is_nothrow_move_constructible< std::vector<int> >::value << '\n' 

              << "is vector<T> nothrow_move_assignable if T is nothrow_move_assignable? " 
              << std::is_nothrow_move_assignable< std::vector<int> >::value << '\n' 
