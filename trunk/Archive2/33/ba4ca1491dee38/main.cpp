// Outer/Inner block scopes examples and outer scope value multiplication + simplified declarations and vector addition.
// Author: !ixAlastor2 ‮❤✨~oht omoh on srS~✨❤‮‭‭
// Referenced http://coliru.stacked-crooked.com/a/92c40af6be155c73
#include <iostream>
#include <vector>
#include <string>
...
int main() //vital for the entire thing to work~ 
{
    ...
    //>tfw no more 20 lines of declaring integer variables.
    {
        ...
        //to remain unaffected by the declarations in lines 12-14
        {
            ...
            vector<string> P{"getting ", "Finally ", "use "};
            vector<string> L{"pretty ", "figured ", "cout"};
            vector<string> S{"easy", "out ", " :3 \n"};
