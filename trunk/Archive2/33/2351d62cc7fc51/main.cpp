...
int main()
{
    ...
    //
    // Also, using iterators is a powerful and elegant way to work with the elements of any data container--such as the string class.
    ...
    cout << onelife << endl;
    //    
    // And of course existing strings can simply be reassigned to, just like other types can be.
