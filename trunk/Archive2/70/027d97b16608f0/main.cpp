...
int main() {
    ...
    struct RunningShoes : Person::visitor, Athlete::visitor, Singer::visitor {
        virtual void visit( Athlete* ) override { std::cout << "Athlete puts on the running shoes.\n" ; }
    	virtual void visit( Singer* ) override { std::cout << "Singer has no need for the running shoes.\n" ; }
    };
    
    struct Microphone: Person::visitor, Athlete::visitor, Singer::visitor {
    	virtual void visit( Athlete*) override { std::cout << "Athlete has no need for the microphone.\n" ; }
    	virtual void visit( Singer* ) override { std::cout << "Singer sings with the microphone.\n" ; }
    };
    
    struct KaraokeWalkman : Person::visitor, SingingAthlete::visitor {
        virtual void visit( SingingAthlete* ) override { std::cout << "SingingAthlete jogs with the KaraokeWalkman.\n" ; }
    };
