...
static inline
ObjFunCallback<T_return,T_obj,arg1,arg2> make_callback(T_obj obj, T_return(T_obj::* func)(arg1, arg2), arg1 a_1, arg2 a_2) {
	return ObjFunCallback<T_return,T_obj,arg1,arg2>(func,obj,a_1,a_2);
}

template<class T_return, class T_obj>
static inline AbstractCallbackPtr make_callbackPtr(T_obj obj, T_return(T_obj::* func)()) {
	return AbstractCallbackPtr(new ObjFunCallback<T_return,T_obj>(func,obj));
}

template<class T_return, class T_obj, class arg1>
static inline AbstractCallbackPtr make_callbackPtr(T_obj obj, T_return(T_obj::* func)(arg1), arg1 a_1) {
	return AbstractCallbackPtr(new ObjFunCallback<T_return,T_obj,arg1>(func,obj,a_1));
}

template<class T_return, class T_obj, class arg1, class arg2>
static inline AbstractCallbackPtr make_callbackPtr(T_obj obj, T_return(T_obj::* func)(arg1, arg2), arg1 a_1, arg2 a_2) {
	return AbstractCallbackPtr(new ObjFunCallback<T_return,T_obj,arg1,arg2>(func,obj,a_1,a_2));
}
...
int main()
{
   ...
   AbstractCallbackPtr ptr1 = make_callbackPtr(t1,&Test::fun1,10);
   (*ptr1)();
