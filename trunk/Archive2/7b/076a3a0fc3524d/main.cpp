...
// Trying to instantiate Diagnose<Expected<Expr>> sadly produces a somewhat incomplete
// template instantiation stack at least with GCC
template instantiation stack with GCC
