...
template<typename ...Tail> void pop(VLANDecoder vlandec, Tail... tail);
template<typename ...Tail> void pop(IPv4Decoder ipdec, Tail... dec);
template<typename ...Tail> void pop(IPv6Decoder ipdec, Tail... dec);
