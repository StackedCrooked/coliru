...
int main ( int argc, char *argv[] )
{
	...
	std::cout << Log::LogEntry( LOG_NOTICE, Log::NETWORK, StringBuilder() << "LOG1::This is a test " << i).Hex() << "\n" << std::endl;
	std::cout << Log::LogEntry( LOG_NOTICE, Log::NETWORK, StringBuilder() << "LOG2::This is a test also " << i).Text() << "\n" << std::endl;
	std::cout << Log::LogEntry( LOG_NOTICE, Log::SYSLOG, "LOG3::%f, %d", f,i ).Hex() << "\n" << std::endl;
	std::cout << Log::LogEntry( LOG_NOTICE, Log::SYSLOG, "LOG4::THIS IS A TEST" ).Text() << "\n" << std::endl;
