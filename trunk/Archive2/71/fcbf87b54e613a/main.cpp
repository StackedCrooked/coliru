        ...
        if (arr[x][y]==1)
         {
            ...
            if ((x==1) && (y==1)) {
                ...
                if ((arr[1][1]==1) && (arr[2][2]==1) && (arr[3][3]==0)) {arr[1][1]=0;arr[2][2]=0;arr[3][3]=1;arr[0][0]--; Move(arr); }
                }
            if ((x==1) && (y==2)) {}
            if ((x==1) && (y==3)) {
                if ((arr[1][3]==1) && (arr[1][2]==1) && (arr[1][1]==0)) {arr[1][3]=0;arr[1][2]=0;arr[1][1]=1;arr[0][0]--; Move(arr); }
                if ((arr[1][3]==1) && (arr[1][4]==1) && (arr[1][5]==0)) {arr[1][3]=0;arr[2][4]=0;arr[1][5]=1;arr[0][0]--; Move(arr); }
                if ((arr[1][3]==1) && (arr[2][3]==1) && (arr[3][3]==0)) {arr[1][3]=0;arr[2][3]=0;arr[3][3]=1;arr[0][0]--; Move(arr); }
                }
            if ((x==1) && (y==4)) {}
            if ((x==1) && (y==5)) {}
            if ((x==2) && (y==2)) {}
