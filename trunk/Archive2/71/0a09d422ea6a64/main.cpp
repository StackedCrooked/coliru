...
class blockstep_iterator {
    ...
    static type get_step() {return type(blockstep);}
    static type get_max() {return type(max);}
    };
    template<class type> struct blockstep_tuple<type,2> {
        typedef std::tuple<type,type> type; 
    static type get_step() {return type(blockstep,blockstep);}
        static type get_max() {return type(max,0);}
    };
    template<class type> struct blockstep_tuple<type,3> {
        typedef std::tuple<type,type,type> type; 
    static type get_step() {return type(blockstep,blockstep,blockstep);}
        static type get_max() {return type(max,0,0);}
    };
    template<class type> struct blockstep_tuple<type,4> {
        typedef std::tuple<type,type,type,type> type; 
    static type get_step() {return type(blockstep,blockstep,blockstep,blockstep);}
        static type get_max() {return type(max,0,0,0);}
    };
    template<class type> struct blockstep_tuple<type,5> {
        typedef std::tuple<type,type,type,type,type> type; 
    static type get_step() {return type(blockstep,blockstep,blockstep,blockstep,blockstep);}
        static type get_max() {return type(max,0,0,0,0);}
    };
    template<class type> struct blockstep_tuple<type,6> {
        typedef std::tuple<type,type,type,type,type,type> type; 
    static type get_step() {return type(blockstep,blockstep,blockstep,blockstep,blockstep,blockstep);}
        static type get_max() {return type(max,0,0,0,0,0);}
    };
    typedef typename blockstep_tuple<type,count>::type tuptype;
    tuptype get_step() {return blockstep_tuple<type,count>::get_step();}
    tuptype get_max() {return blockstep_tuple<type,count>::get_max();}
