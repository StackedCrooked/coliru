...
boost::regex nameExpression("[a-zA-Z0-9 ]{1,20}");  // alphanumeric or space and between 1 and 20 characters.
boost::regex nameShortExpression("[a-zA-Z0-9 ]{1,6}");  // alphanumeric or space and between 1 and 6 characters.
