...
void log2_test() {
    ...
    auto print = [](std::string desc, std::function<std::size_t(std::size_t)> func){
        std::cout << desc;
    ...
    print("int_log:      ", [](std::size_t s){return int_log(s);});
    ...
    auto calc = [&](std::string desc, std::size_t j, std::function<std::size_t(std::size_t)> func){
    ...
    calc("int_log:      ", 1, [](std::size_t s){return int_log(s);});
