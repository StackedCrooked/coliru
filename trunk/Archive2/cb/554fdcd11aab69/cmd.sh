##clang++ --version
##g++-4.8 --version2
set -x ;g++-4.8 -std=c++11   -Wall -Wextra -Wconversion -Wnarrowing -Wundef -pedantic-errors -O3 -pthread  main.cpp && ./a.out 
##g++ --version
...
##set -x ; gcc -x c -std=c99 -O0  -Wall -Wconversion -pedantic main.cpp && ./a.out
##set -x ; gcc -x c -std=c99 -O0 -W -Wall -Wextra -Wconversion -pedantic -S main.cpp && cat main.s 
##set -x ; clang -x c  -fsanitize=undefined   -Wall -Wextra -Wconversion -O1  -pedantic  main.cpp && ./a.out