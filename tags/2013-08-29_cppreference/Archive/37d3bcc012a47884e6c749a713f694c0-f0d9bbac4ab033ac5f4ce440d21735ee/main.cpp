...
struct multiplex_functions_helper:handle_function<typename std::decay<Fs>::type>...
{
    typedef boost::variant< ReturnType<Fs>... > return_type;
    template<typename... F2s>
    multiplex_functions_helper( F2s&&... fs ):
        handle_function<typename std::decay<Fs>::type>( std::forward<F2s>(fs) )...
    {}
};
template< typename... Fs>
struct multiplex_functions:multiplex_functions_helper<Fs...>
{
    typedef typename multiplex_functions_helper<Fs...>::return_type return_type;
    template<typename... Args>
    return_type operator()(Args&&... args) const {
        return return_type(static_cast< multiplex_functions_helper<Fs...> const& >(*this)( std::forward<Args>(args)... ));
    }
    template<typename... Args>
    return_type operator()(Args&&... args) {
        return return_type( static_cast< multiplex_functions_helper<Fs...>& >(*this)( std::forward<Args>(args)... ));
    }
    template<typename... F2s>
