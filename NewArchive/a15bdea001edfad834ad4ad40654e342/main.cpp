...
// SOLUTION 1b: Bridge pattern.
//
// Properties:
// - Behaves like built-in types (copy generates a unique object).
// - Private impl object implements clone-based copy.
// - Pointer indirection and virtual dispatch may hurt performance.
//
// Score: 8/10.
...
// The IP class can represent IPv4 and IPv6 addresses.
class IP
{
public:
    enum Type { v4, v6 }; 
