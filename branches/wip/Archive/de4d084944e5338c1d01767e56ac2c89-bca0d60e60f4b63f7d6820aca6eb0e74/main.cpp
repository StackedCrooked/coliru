...
// This is what we want to do, but due to in-place construction/copy-elision
// optimization, this doesn't show the old construct-from-temporary behavior
    //auto Obj = SubClass();
    //return Obj;
    
// This 2-step process is necessary to simulate old temporary object return behavior
// (do NOT use in practice)
    auto ObjTmp = SubClass();
    auto Obj = std::move(ObjTmp);
