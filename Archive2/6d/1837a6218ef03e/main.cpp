...
void askValues(int a[], int);
void dispValues(int a[], int);
int countOdd(int a[], int);
int countEven(int a[], int);
void copyOdd(int a[], int b[], int);
void copyEven(int a[], int b[], int);
...
void dispSmallest(int a[], int s)
{
    ...
    cout << small; // maganda kung lagyan mu ng '\n' or endl;
}
...
void dispLargest(int a[], int s)
{
    ...
    cout << largest; // maganda kung may endl or '\n'
}