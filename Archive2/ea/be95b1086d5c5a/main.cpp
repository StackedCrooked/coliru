...
struct improvised_container :
	...
	improvised_container(disambiguated_wrapper<int_wrapper, N> dw_, Tn... args) :
		disambiguated_wrapper<int_wrapper, N>(dw_),
		improvised_container<N - 1>(args...) {}
...
protected disambiguated_wrapper<int_wrapper, 1>{
	...
	template <typename ...Tn>
	improvised_container(Tn ...args) :
		disambiguated_wrapper<int_wrapper, 1>(args...) {}
...
int main() {
	improvised_container<5> my_container = { 0, 1, 2, 3, 4 };
