...
int main() {
	using NestedPack = Pack<long, Pack<long, char>, double, Pack<long, Pack<int, long>, short, int>, char, int>;
	static_assert(std::is_same<remove_first_t<int, NestedPack>, Pack<long, Pack<long, char>, double, Pack<long, Pack<long>, short, int>, char, int>>::value, "Oops");
}
