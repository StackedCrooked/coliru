...
void my_funky_func()
{
   // Initialize two source string vectors element's with three different string values each.
   ...
   // Process the source vector's string elements together one by one, and assign
   //  that into each of the target vector's elements one by one simultaneously.
