...
namespace local
{
    void test6(void); void test5(void); void test4(void); void test3(void); void test2(int&); void test1(void); template<typename A> void dumpMapReverse(const A &map);
}
...
namespace local
{
    ...
    private:
        int mine_;
    public:
        Me(void) : mine_(-1) { cout << "constructor" << endl; }
        Me(const int input) : mine_(input) { cout << "constructor-1v" << endl; }
        Me(const Me& input) : mine_(input.mine_) { cout << "copy constructor" << endl; }
        Me(Me&& input) : mine_(input.mine_) { cout << "move constructor" << endl; }
