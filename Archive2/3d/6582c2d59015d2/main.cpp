...
template <typename V, 
    typename Alloc = typename V::allocator_type,
    typename Element // = typename V::value_type>
>
...
template <typename V>
static inline void resize(V& vect, size_t newsize, typename V::allocator_type alloc_inst)
{
