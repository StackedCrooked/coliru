...
int main()
{
...

    {
        ...
        oa << o; // you can also use a raw `Interface*` but I hate new/delete
...

    {
        ...
        //boost::shared_ptr<Interface> o = boost::make_shared<Derived<int> >(42);
        Interface* o = nullptr;

        ia >> o; // you can also use a raw `Interface*` but I hate new/delete
