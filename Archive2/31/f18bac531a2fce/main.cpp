...
void bubblesort(std::vector<Person>& v, Pred pred)
{
...
int main()
{
    ...
    bubblesort(table, [](Person const& a, Person const& b) { return a.fullname < b.fullname; });
    output("by name", table);

    bubblesort(table, [](Person const& a, Person const& b) { return a.age < b.age; });
    output("by age", table);
}
