...
int main()
{
    ...
    //onelife.replace(0, onelife.size() - 1, otherlife);          // instead of needing this form,
    onelife.replace(onelife.begin(), onelife.end(), otherlife);   // you can use this form instead
