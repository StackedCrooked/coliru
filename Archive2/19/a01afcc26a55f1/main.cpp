...
int main()
{
    // Person has FirstName name, LastName name and age fields.
    using FirstName = StrongTypedef<std::string, struct FirstName_>;
    using LastName = StrongTypedef<std::string, struct LastName_>;
    using Age = StrongTypedef<int, struct Age_>;    
    using Person = Handy<FirstName, LastName, Age>;
    ...
    std::cout <<  "FirstName: " << p.get<FirstName>()
