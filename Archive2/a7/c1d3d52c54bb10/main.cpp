...
template <typename BidirIt, typename It>
void multi_partition( BidirIt, BidirIt, It ) {}

template <typename BidirIt, typename Pred, typename OutputIterator, typename... Predicates>
void multi_partition( BidirIt first, BidirIt last,
	OutputIterator out, Pred pred, Predicates... preds )
{
