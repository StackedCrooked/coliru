...
template<typename T>    const std::string& mapperC2CXX(       char* t ) { return std::string(t); }
template<typename T>    const std::string& mapperC2CXX( const char* t ) { return std::string(t); }
template<typename T>    const std::string& mapperC2CXX( PyObject*   p ) { return Object{p}; }
