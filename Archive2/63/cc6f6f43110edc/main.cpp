...
// 2014 April 6;  Aurthor : Mr Lam/ Yee Din(林貽典)  Email: yeedlam@yahoo.com
...
for (m = 0; m - 1 < 90; m ++)
{
  ...
  double  Center_Y_extra = Center_Y + 0.1563 - 0.0016946782746*Sun_arc;  //590.0825;  //suppose modified by 邢雲路
  //----------------------------------------------------------------------------------------------------------------
  ...
  double  Center_W = Center_ZRef/Center_Y;            //            以赤道小弦而一，為赤道大句(Center_W)
       // Center_W = [Cenetr_Z*(d/2)] / Center_Y  
  ...
  double  SY_b=(d/2.0)-Center_Y_extra;//頁787-737(二至前後黄道距赤道內外度):  置半徑以減赤道小弦，餘為赤道二弦差，一云赤道矢(SY_b)
                                               // 置半徑減黄道矢，餘為黃赤道弦，一為立股，若相近曰句，
  double  Sun_Y = Center_X * Sun_Y24Ref/(d/2.0); // 以二至內外黄赤道半弧弦乘之，以半徑六十度八七五而一，得黃赤道小弧弦(Sun_Y)
       // Sun_Y = [Center_X/(d/2)] * Sun_Y24Ref  
