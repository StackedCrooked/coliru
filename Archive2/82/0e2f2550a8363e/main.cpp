...
/* Switch this macro on/off to check out the use of the different
 * implementations of the WrapValueImpl class. If this is off, we will
 * see
 *
 *     TestValue::Type::to_string() [this is the expected print]
 *
 * in the console, which is what I expected! However, if you turn it on,
 * you can see the compiler complaining about the implementation of
 * WrapValueImpl::Type::to_string().
 *
 * Why does it complain if it actually does not use this type?
 */
#define SHOW_ARRAY 0
