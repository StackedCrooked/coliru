...
#define LING_ASSERT_OPT_MESSAGE(condition, message) LING_ASSERT_OPT(condition)
...
#define LING_ASSERT_MESSAGE(condition, message) LING_ASSERT(condition)
...
#define LING_ASSERT_SAFE_MESSAGE(condition, message) LING_ASSERT_SAFE(condition)
