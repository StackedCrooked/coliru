...
template < typename T, typename U >
constexpr auto cmax(T t, U u) -> decltype( t>u?t:u ) { return t>u?t:u; }
...
private:
    ...
    struct helper<true, dummy>
    {
        ...
        static constexpr auto maxT = std::numeric_limits<T>::max();
        static constexpr auto maxU = std::numeric_limits<U>::max();
