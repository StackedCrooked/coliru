...
struct fizz : public base_item {
    void print(std::ostream& out) const override {
        out << "Fizz";
    }
};

struct buzz : public base_item {
    void print(std::ostream& out) const override {
        out << "Buzz";
    }
};

struct fizz_buzz : public base_item {
    void print(std::ostream& out) const override {
        out << "FizzBuzz";
    }
};

struct number : public base_item {
...
fizz_buzz_item make_fizz_buzz(unsigned value) {
    using namespace fizz_buzz_items;
