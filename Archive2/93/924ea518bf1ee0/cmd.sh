##g++ --version
set -x ; g++-4.6 -std=c++0x -Wall -Wextra -Wconversion -pedantic  -O0  -pedantic  -pthread main.cpp && ./a.out
##g++ --version
...
##set -x ; clang -x c -std=c99 -fsanitize=undefined -Wall -Wextra   -O0  -pedantic main.cpp && ./a.out