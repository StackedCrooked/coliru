...
struct PossibleActions<First, Rest...> : ActionType<First>, PossibleActions<Rest...> {
    void operator()(int a) const {
        static_cast<const ActionType<First>*>(this)->foo(a);
...
struct Object : merge<PossibleActions<1, 2>, PossibleActions<3, 4>>
{
    void foo(int a)
    {
        merge<PossibleActions<1, 2>, PossibleActions<3, 4>>::operator()(a);
    }
};
...
struct Blob : merge<PossibleActions<0>, merge<OneAndFour, TwoAndThree>>
{
    void foo(int a)
    {
        merge<PossibleActions<0>, merge<OneAndFour, TwoAndThree>>::operator()(a);
    }
};
...
int main()
{
    ...
    ActionType<0>* p0 = &blob; p0->foo(0);
    ActionType<1>* p1 = &blob; p1->foo(1);
    ActionType<2>* p2 = &blob; p2->foo(2);
    ActionType<3>* p3 = &blob; p3->foo(3);
    ActionType<4>* p4 = &blob; p4->foo(4);
}
