...
int main()
{
  double tokens=0, prism=0, banking=0, conquest=0, guilded_chests=0, midas_touch=0,  force_multiply=0, train_heros=0, level=0;
  ...
  guilded_chests=0;
  midas_touch=0;
  level=0; // <-----This is the level you reached on your last run.
  //****************************************************************************
