...
const double  Sun_Y24Ref = 23.78151; 
...
for (m = 0; m - 1 < 90; m ++)
{
  ...
  double  Theo_s_arc = 90-180/pi * atan(tan(Ref_degree* pi/180) * cos(23.6550 * pi/180));
  double  TheoYR_Diff = Theo_s_arc - deg360;
  double  TheoSun_Lat = 180/pi * asin(sin(Ref_degree * pi/180) * sin(23.6550 * pi/180));
