...
using PyObject = void;
    ...
    public:
        ...
        Object( PyObject* pyob ) { std::cout << "default\n"; }
    private:
        // constructor helpers return charged pointer
        PyObject* pyob_from(bool    b) { cout << "int"; return nullptr; }

        template<typename T> PyObject* pyob_from_integral(T t) { std::cout << "int\n"  ; return nullptr; }
        template<typename T> PyObject* pyob_from_floating(T t) { std::cout << "float\n"; return nullptr; }
    };
/*
