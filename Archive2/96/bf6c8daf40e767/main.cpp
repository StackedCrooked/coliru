...
namespace sehe
{
    ...
    template <typename KeyType, typename ValueType, typename Compare, typename Allocator, typename ValueAllocator, typename Element = mutable_pair< KeyType, ValueType, Allocator > >
        struct map_gen
        {
