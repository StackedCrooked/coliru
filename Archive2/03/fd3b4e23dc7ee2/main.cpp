...
struct Employees {
    Employees(const char* f, const char* l, int s);    
...
Employees::Employees(const char* f, const char* l, int s)
:mFirstName(f), mLastName(l), mSalary(s)
{}

Manager::Manager(const char* f, const char* l, int s, int m, int v)
:Employees(f, l, s), mNumberOfMeetingsPerWeek(m), mNumberOfVacationDaysPerYear(v)
{}
