...
#define requires(__VA_ARGS__) typename = std::enable_if_t<Concepts<__VA_ARGS__>, int>
...
template <typename T>
static constexpr bool Concept = decltype(detail::ConceptImpl<T>::test(0))::value;

template <typename... Ts>
static constexpr bool Concepts = true;

template <typename T, typename... Ts>
static constexpr bool Concepts<T, Ts...> = Concept<T> && Concepts<Ts...>;
...
template <typename T, requires(HasEq(T))>
