...
namespace fm {
    namespace rand {
		...
		namespace literals {
			auto operator "" _d4(unsigned long long n) { 
				return [n] { return d4(n); }; 
			}
			auto operator "" _d6(unsigned long long n) { 
				return [n] { return d6(n); }; 
			}
			auto operator "" _d8(unsigned long long n) { 
				return [n] { return d8(n); }; 
			}
			auto operator "" _d10(unsigned long long n) { 
				return [n] { return d10(n); }; 
			}
			auto operator "" _d12(unsigned long long n) { 
				return [n] { return d12(n); }; 
			}
			auto operator "" _d20(unsigned long long n) { 
