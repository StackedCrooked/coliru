##g++ --version
##clang++ --version
##clang++  -std=c++11 -O3  -W -Wall -Wextra -Wconversion -pedantic   main.cpp && ./a.out
##g++ --version
...
##c++filt -t d
##gcc -x c -std=c99  -W -Wall -Wextra -Wconversion -pedantic  -O3 -fno-builtin  main.cpp -pthread -lm && ./a.out
