...
class A {
    public:
        ...
        ~A() { cout << "A destructor, default_constructed: " << (is_default_constructed ? "true" : "false") << endl; }
    private:
...
class B : public A {
    public:
        ...
        ~B() { cout << "B destructor, default_constructed: " << (is_default_constructed ? "true" : "false") << endl; }
    private:
        bool is_default_constructed;
};
