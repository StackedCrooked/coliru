##clang++ --version
##g++-4.8 --version2
##set -x ;g++-4.9 -std=c++11   -Wall -Wextra -Wconversion -Wnarrowing -Wundef  -Wshadow -O3 -pthread  main.cpp && ./a.out 
##g++ --version
##set -x ; g++-4.9 -std=c++11 -Wall -Wextra -Wconversion -pedantic  -O3  -pedantic  -pthread -S main.cpp && cat main.cpp 
set -x ; clang++  -std=c++11 -fsanitize=undefined,signed-integer-overflow  -O3 -Wall -Wextra -Wconversion -pedantic -Wall -Weffc++ -pthread  main.cpp && ./a.out 
