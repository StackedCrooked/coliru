...
int main() //vital for the entire thing to work~ 
{
    ...
    //>tfw no more 20 lines of declaring integer variables.
    {
        ...
        //to remain unaffected by the declarations in lines 12-14
        {
            ...
            P{"gey ", "nurd ", "me "}, 
            L{"and ", "and ", "with "}, 
            S{"is ", "should ", " pointers or whatever it was \n"}, 
            Kden(3);
    ...
    int myint;
    vector<int> v1{60, 30, 20, 10, 63, 69, 69, 69}; //We make it so that the length of this vector is 8
    vector<int> v2{9, 39, 49, 59, 6}; // and we make the length of this vector five
