...
int main()
{
    ...
    fusion::at_key< mpl::string<'one'> >(occurrence_storage) = 1;
    fusion::at_key< mpl::string<'two'> >(occurrence_storage) = 2;
    fusion::at_key< mpl::string<'thre', 'e'> >(occurrence_storage) = 3;
    fusion::at_key< mpl::string<'four'> >(occurrence_storage) = 3;
