...
template <typename Function, typename Enabled = void>
...
struct identity_element<std::plus<Integer>, typename std::enable_if<std::is_integral<Integer>::value, void>::type> {
