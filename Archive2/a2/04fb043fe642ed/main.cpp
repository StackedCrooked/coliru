...
int main()
{
    ...
    Fraction f1(-4,5);
    Fraction f2(0,1);
    cout << "is f1 negative? "            << std::boolalpha << f1.isNegative() << endl;
    cout << "is f2 zero? "                << std::boolalpha << f2.isZero()     << endl;
    cout << "is f1 a proper fraction? "   << std::boolalpha << f1.isProper()   << endl;
    cout << "is f1 a positive fraction? " << std::boolalpha << f1.isPositive() << endl;
