...
int main(void) {
    struct default_factory { detail::dynamic_interface operator()() const { return do_foo; } };
    using InterfaceWrapper = std::shared_ptr<detail::dynamic_release<default_factory> >;
