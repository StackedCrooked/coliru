...
int main()
{
    constexpr std::size_t TESTSZ = 1000 * 1000 ;
    ...
    // create and destroy a million strings (average size: 10 characters)
    {
    ...
    std::cout << ".    auto: " << double( end_auto - begin_auto ) / CLOCKS_PER_SEC << " secs  "
              << "average size: " <<  double(nauto) / TESTSZ << '\n'
              << "dynanic: " << double( end_dynamic - end_auto ) / CLOCKS_PER_SEC << " secs  " 
