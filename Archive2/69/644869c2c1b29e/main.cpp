...
public:
    ...
    Combiner(Z1 && z1, Z2 && z2)
    : aData(forward<Z1>(z1))
    , bData(forward<Z2>(z2))
    {
        cout << "Universal constructor" << endl;
    }
    
//    Combiner(const T1 & t1, const T2 & t2) 
//    : aData(t1)
//    , bData(t2)
//    {
//        cout << "Constructor copy semamtics" << endl;
//    }
//    
//    Combiner(T1 && t1, T2 && t2) 
//    : aData(move(t1))
//    , bData(move(t2))
//    {
//        cout << "Constructor move semamtics" << endl;
//    }
