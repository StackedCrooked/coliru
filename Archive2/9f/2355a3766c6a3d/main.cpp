...
struct gen_ixs : Ixs{};
template<class... Ixs, unsigned AccX, unsigned AccY, unsigned... Sizes>
struct gen_ixs<list<Ixs...>, AccX, AccY, AccY, Sizes...> : gen_ixs<list<Ixs...>, AccX+1, 0, Sizes...>{};
template<class... Ixs, unsigned AccX, unsigned AccY, unsigned N, unsigned... Sizes>
struct gen_ixs<list<Ixs...>, AccX, AccY, N, Sizes...> : gen_ixs<list<Ixs..., ix<AccX, AccY>>, AccX, AccY + 1, N, Sizes...>{};
