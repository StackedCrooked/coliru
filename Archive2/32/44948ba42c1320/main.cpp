...
// 2014 April 7;  Aurthor : Mr Lam/ Yee Din(林貽典)  Email: yeedlam@yahoo.com
...
for (m = 0; m - 1 < 90; m ++)
{
  ...
  double  Center_YS = Center_Y + 0.1451*Sun_arc;    // try to adjust to make Sun_Lat360 to be 0 degree when Sun_arc = 91.314375     
  //---------------------------------------------------------------------------------------------------------------------------
  ...
  //__________________________________________________________________________________________________________________________
          Center_W = Center_W - 0.00328*Sun_arc;    // try to adjust to make S_arc360 to be 90 degree when Sun_arc = 91.314375
  //--------------------------------------------------------------------------------------------------------------------------
  ...
  //                                    //頁787-737(二至前後黄道距赤道內外度):  置半徑以減赤道小弦，餘為赤道二弦差，一云赤道矢(SY_b)
  //__________________________________________________________________________________________________________________________
  double  SY_b=(d/2.0)-Center_YS;       // Center_Y replaced by Center_YS for adjustment purpose
  //--------------------------------------------------------------------------------------------------------------------------
