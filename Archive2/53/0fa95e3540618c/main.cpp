...
int main () 
{
  ...
  { // Inner block's scope begins here.
    ...
    int x{50}; // Here within the inner block's scope, another new (and totally
               //  different) 'x' variable's initialization is OK, since
               //  we're protected here inside main()'s inner block from
