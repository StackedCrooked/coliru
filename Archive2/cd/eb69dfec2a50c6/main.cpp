...
struct GetBaseType<A, B, typename std::enable_if<std::is_base_of<A, B>::value>::type>
{
...
struct OneRunShift<A, B, Args...>
{
  using type = decltype(std::tuple_cat(
      std::declval<typename GetBaseType<A, B>::type>(),
      std::declval<typename OneRunShift<
        typename std::conditional<std::is_base_of<A, B>::value, B, A>::type,
        Args...
    >::type>()));
};
...
int main()
{
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<A, C, B, C, B, A>::type,
      std::tuple<A, A, B, B, C, C>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<C, B, C, B, A>::type,
      std::tuple<A, B, B, C, C>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<A, D, B, C, B, A>::type,
      std::tuple<A, A, B, B, C, D>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<D, C, B, A, D>::type,
      std::tuple<A, B, C, D, D>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<A, C>::type,
      std::tuple<A, C>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<C, A>::type,
      std::tuple<A, C>
    >::value));
    
  STATIC_CHECK((std::is_same<
      typename HierarchyAlign<A, A, A>::type,
      std::tuple<A, A, A>
    >::value));
}