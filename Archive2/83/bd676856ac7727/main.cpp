...
public:
    ...
    m_lTree(a_lTree)
  {
    ...
    limit_days_operator    = ( "limit" >> qi::uint_ )[ phx::bind( &ConditionTree::AddDaysLimitOperator,    phx::ref(m_lTree), qi::_1) ];
    limit_hours_operator   = ( "limit" >> qi::uint_ )[ phx::bind( &ConditionTree::AddHoursLimitOperator,   phx::ref(m_lTree), qi::_1) ];
    limit_minutes_operator = ( "limit" >> qi::uint_ )[ phx::bind( &ConditionTree::AddMinutesLimitOperator, phx::ref(m_lTree), qi::_1) ];
