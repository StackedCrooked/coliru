...
int main()
{
    // all should pass, compatible signatures:
    std::cout << has_helloworld<Hello, void(int)>::value << '\n';
    std::cout << has_helloworld<Hello, double(int)>::value << '\n';
    std::cout << has_helloworld<Hello, int(double)>::value << '\n';
    std::cout << has_helloworld<Hello, void(std::vector<int>)>::value << '\n';
    std::cout << '\n';
    // all should fail, incompatible signatures:
    std::cout << has_helloworld<Hello, Generic(int)>::value << '\n';
    std::cout << has_helloworld<Hello, void()>::value << '\n';
    std::cout << has_helloworld<Hello, int(Generic)>::value << '\n';
    std::cout << '\n';
    // Gereric has no helloworld:
