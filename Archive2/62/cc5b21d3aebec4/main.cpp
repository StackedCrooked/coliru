...
struct mt19937_16 : private std::mt19937
{
    ...
    private:
        ...
        static std::uniform_int_distribution<std::uint16_t> narrow ;
...
std::uniform_int_distribution<std::uint16_t> mt19937_16::narrow ; // in the implementation file (cpp)

int main()
{
    mt19937_16 twister16 ;
