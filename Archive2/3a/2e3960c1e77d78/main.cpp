...
public:
    ...
    {   cout << "Non-const indexer called.\n" ;
        if (0 > i || this->size() <= i)
        {   cout << "Non-const indexer called with bogus index " << i << endl;
    ...
    {   cout << "Const indexer called.\n" ;
        if (0 > i || this->size() <= i)
        {   cout << "Const indexer called with bogus index " << i << endl;
            throw out_of_range {"Vector::operator[]"};   }
        return this->elems[i];   }
