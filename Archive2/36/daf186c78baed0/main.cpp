...
namespace crap_detail {
    ...
    struct shit_equals : std::integral_constant<bool, std::is_same<Tr, Tl>::value> {};
...
template <typename Tr, typename Tl>
struct c_string_equals : crap_detail::shit_equals<Tr, Tl> {};

template <std::size_t... C>
using c_string = crap_detail::shitter<C...>;
