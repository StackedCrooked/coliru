...
int main(void)
{
    ...
    /* générer les X */
    printf("Generer des valeurs aleatoires suivant la loi normale de moyenne 1.0 et de variance 4.0\n"); /* variance == equart type ^2*/
    for(size_t i=0;i<300;++i)
    {
        /* on génère un tableau de X et on les affiche au fur et à mesure. Ces nombres aléatoires suivent la loi normale. */
        printf("%0.3f\n",normal_rand(params)); /* changer %0.3f pour changer la précision de l'affichage */
    }
    return 0;
}
