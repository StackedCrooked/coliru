...
namespace emulation {
    ...
    template <typename Key, typename T, typename Compare, typename Allocator, typename Element = mutable_pair<Key, T> >
...
#if 0
    typedef std::pair<const String, String> MapItem;
    typedef boost::interprocess::allocator<MapItem, SegmentManager> MapItemAllocator;
    typedef boost::interprocess::map<String, String, StringComparator, MapItemAllocator> Map;
#else
    typedef emulation::mutable_pair<const String, String> MapItem;
    typedef boost::interprocess::allocator<MapItem, SegmentManager> MapItemAllocator;
    typedef emulation::map<String, String, StringComparator, MapItemAllocator> Map;
#endif
}
...
int main(void) {
    ...
    Shared::Map *myMapPtr = seg.construct<Shared::Map>("myMap")(alloc);
