...
int main() {
    ...
    std::sort(even_numbers.begin(), even_numbers.end(), pred);
    std::sort(odd_numbers.begin(), odd_numbers.end(), pred);
    std::cout << "Max number of even number digits: " << even_numbers << std::endl;
    std::cout << "Max number of odd number digits: " << odd_numbers << std::endl;
}