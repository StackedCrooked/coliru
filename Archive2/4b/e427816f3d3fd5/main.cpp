...
enum class A { min, i, j, k, ii, jj, kk, max };
...
template<>
struct Aattr<A::ii> {
    static constexpr const char* name = "A::ii";
    static void f() { cout << name << endl; }
};

template<>
struct Aattr<A::jj> {
    static constexpr const char* name = "A::jj";
    static void f() { cout << name << endl; }
};

template<>
struct Aattr<A::kk> {
    static constexpr const char* name = "A::kk";
    static void f() { cout << name << endl; }
};
...
template <A k>
Attributes GetAttr() {
    return BuildAttributes<Aattr<k>>();
}

template <B k>
Attributes GetAttr() {
    return BuildAttributes<Battr<k>>();
}
