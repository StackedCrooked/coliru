...
void Function()
{
    ...
    std::sort(Bs.begin(), Bs.end(), comparer_by(phx::construct<std::string>(phx::bind(&foo::c_str, phx::lambda [ phx::bind(&bar::X, arg1) ](arg1) )))); // this is where deduction is _very_ handy
