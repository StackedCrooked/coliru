...
std::string serialize_impl(int, Identity<int>);
std::string serialize_impl(bool, Identity<bool>);
std::string serialize_impl(double, Identity<double>);

void deserialize_impl(std::string, int&, Identity<int>);
void deserialize_impl(std::string, bool&, Identity<bool>);
void deserialize_impl(std::string, double&, Identity<double>);
...
// deserialize (parse) string to object of requested type
template<typename T>
