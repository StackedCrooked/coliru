...
int main()
{
    ...
    std::vector<SLDBConfigParams> parameterInfo = {
        ...
        SLDBConfigParams("INAVDATAHI_16M._xr", "proc1", PriorityLevel(6, 'B', 1)),
        SLDBConfigParams("envmoddir._dr", "proc2", PriorityLevel(6, 'B', 1)),
        SLDBConfigParams("jeppall._dr", "proc3", PriorityLevel(6, 'B', 2)),
        SLDBConfigParams("tfsdir._dr", "proc4", PriorityLevel(6, 'B', 1)),
