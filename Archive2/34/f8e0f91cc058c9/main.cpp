...
int main()
{
    ...
    std::cout << "vertice " << i << " in vinf1: {" << int(vinf1.vertices[i].x) << ", "  << int(vinf1.vertices[i].y) << ", "  << int(vinf1.vertices[i].z) << "}" <<  std::endl;
    std::cout << "vertice " << i << " in vinf2: {" << int(vinf2->vertices[i].x) << ", "  << int(vinf2->vertices[i].y) << ", "  << int(vinf2->vertices[i].z) << "}" << std::endl;
    }
    return 0;
}