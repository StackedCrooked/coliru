    ...
    struct parser : qi::grammar<It, expr(), Skipper>
{
    parser() : parser::base_type(expr_)
    {
        ...
        or_  = xor_ [_val = _1] >> -("or"  >> or_  [_val = phx::construct<binop<op_or >>(_val, _1)]);
        xor_ = and_ [_val = _1] >> -("xor" >> xor_ [_val = phx::construct<binop<op_xor>>(_val, _1)]);
        and_ = not_ [_val = _1] >> -("and" >> and_ [_val = phx::construct<binop<op_and>>(_val, _1)]);
