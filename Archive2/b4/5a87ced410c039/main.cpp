...
const double R_air_6 = R_air*51325/101325.; // UWAGA: wskazanie na ciśnieniomierzu "-0.05 MPa" zatem licznik 101325-0.05e6
...
const double ps[] = {0.00185, 0.002, 0.004, 0.006, 0.008, 0.01, 0.012, 0.014, 0.016, 0.018, 0.020, 0.022, 0.024}; // dystans w powietrzu
