...
template <>
struct parameter_type_traits<empty_parameter> {
  typedef std::vector<double> type;
};

template <class opt1_type, class opt2_type>
func_functor<typename parameter_type_traits<opt1_type>::type,
             typename parameter_type_traits<opt2_type>::type>
make_func(const opt1_type&, const opt2_type&) {
  return func_functor<typename parameter_type_traits<opt1_type>::type,
                      typename parameter_type_traits<opt2_type>::type>();
}
