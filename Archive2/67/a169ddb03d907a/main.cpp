...
int main() {
    ...
    //for(int i=0; i<n; i++) values[i] = 1;  //no zeros
    //for(int i=0; i<n; i++) values[i] = rand()%128;  //1.5% zeros
    //for(int i=0; i<n; i++) values[i] = rand()%2;  //50% zeros
    //for(int i=0; i<n; i++) values[i] = rand()%64 == 0 ? 1 : 0;  //98.5% zeros
