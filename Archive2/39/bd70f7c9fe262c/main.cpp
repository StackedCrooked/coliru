...
std::vector<int> make_data_set( int minv = 1'000'000, int maxv = 1'000'000'000, std::size_t N = 1'000'000 )
{
...
int main()
{
    ...
    const auto p = find_matching_pair( data, 100'000'000 ) ; // sums up to 100000000
    if( p != NOT_FOUND )
    {
