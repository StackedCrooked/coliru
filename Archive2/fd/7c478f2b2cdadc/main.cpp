...
public:
    ...
    intmax_t read(void* pBuffer, const intmax_t& rLength);
    intmax_t readFrom(void* pBuffer, const intmax_t& rIndex, const intmax_t& rLength) const;
    intmax_t write(const void* pBuffer, const intmax_t& rLength);
    intmax_t writeAt(const void* pBuffer, const intmax_t& rIndex, const intmax_t& rLength);
};
