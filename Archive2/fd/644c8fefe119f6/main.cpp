...
namespace details{
    ...
    {   
        ...
        static const T i = (R<=C)?            R*N + C - R*(R+1)/2     :         C*N + R - C*(C+1)/2;
    };
}
...
struct CGTraits{
    ...
    using edgesForNode =
        meta::list<
            meta::list_element<I,NodeDataTypes>,
            meta::transform<
                meta::as_list<meta::make_index_range< toLinearSym<I::value , I::value, nNodes>::i, 
                                                      toLinearSym<I::value , nNodes-1  , nNodes>::i+1 > >,
    ...
    /** produces this list   
     * meta::list<
            meta::list<NodeDataA, meta::list<EdgeDataAA, EdgeDataAB, EdgeDataAC> >,
            meta::list<NodeDataB, meta::list<EdgeDataBB, EdgeDataBC> >,
            meta::list<NodeDataC, meta::list<EdgeDataCC> > 
        >
    */
    using nodesToEdges = 
        meta::transform<
    ...
    using nodesForEdge =
        meta::list<
            ...
            meta::list<
                meta::list_element< meta::size_t< toRowColSym<I::value , nNodes>::i> , NodeDataTypes>,
                meta::list_element< meta::size_t< toRowColSym<I::value , nNodes>::j> , NodeDataTypes>
            >
        >;
...
class Edge{
    ...
    // End and start node
    using NodeDataTypes = meta::list_element<meta::size_t<1>, 
                                typename Traits::template nodesForEdge< typename Traits::template getEdgeDataIdx<EdgeData> > 
                                >;
                                
                                
    using StartNodeType = Node<   meta::list_element<meta::size_t<0>, NodeDataTypes> ,  Traits >; 
    using EndNodeType   = Node<   meta::list_element<meta::size_t<1>, NodeDataTypes> ,  Traits >; 
...
class Node{
    ...
    using EdgeDataTypes = meta::list_element<meta::size_t<1>, 
                                typename Traits::template edgesForNode< typename Traits::template getNodeDataIdx<NodeData> > 
                                >;
    ...
    using EdgeStoragesTypes = meta::transform<  
                            EdgeDataTypes,
                            meta::compose< 
                                meta::quote<std::vector>,
                                meta::quote<meta::eval>, // add pointer needs to be evaluated ::type
                                meta::quote<std::add_pointer>,
                                meta::bind_back<meta::quote<Edge>,Traits> 
                            >
                        >;
                        
    using EdgeStorageType = meta::apply_list< meta::quote<std::tuple>, EdgeStoragesTypes>;
