...
template <std::size_t... ARGS>
void func(std::_integer_sequence<ARGS...>&& is)
{
...
int main()
{
	func(std::_make_integer_sequence<5>());
    //std::_make_integer_sequence<5>::print();
    std::cout << std::endl;
    std::cout << std::make_tuple(1, 'a', " asdf", std::string(" äöüäö")); std::cout << std::endl; // prints a tuple
}
