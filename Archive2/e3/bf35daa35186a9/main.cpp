...
int main()
{
    ...
    //
    // Also, using iterators is a powerful and elegant way to work with the elements in any data container--such as the string class.
    ...
    cout << onelife << endl;
    //    
    // Of course strings can simply be reassigned to, just like other types can be.
