...
int main()
{
    { int seq[] { 1,2,3,4 } ; print(seq) ; } // [ 1 2 3 4 ]

    { std::array<int,4> seq{ { 1,2,3,4 } } ; print(seq) ; } // [ 1 2 3 4 ]

    { std::vector<int> seq{ 1,2,3,4 } ; print(seq) ; } // [ 1 2 3 4 ]

    { std::vector< std::vector<int> > seq { { 1,2,3,4 }, {5,6}, {7,8,9} } ; print(seq) ; }
    // [ [ 1 2 3 4 ] [ 5 6 ] [ 7 8 9 ] ]

    { std::deque< std::list<int> > seq { { 1,2,3,4 }, {5,6}, {7,8,9} } ; print(seq) ; }
    // [ [ 1 2 3 4 ] [ 5 6 ] [ 7 8 9 ] ]
    ...
    { std::unordered_map< int, std::deque<char> > seq{ { 1, {'C','D','E'} }, { 2, {'A','B'} } } ; print(seq) ; }
    // [ {2 ,[ A B ] } {1 ,[ C D E ] } ]
}
