...
template <typename List, typename Pred>
using qsort_t = typename qsort__< List, function_<greater_> >::type::type;
...
int main()
{
  ...
  using list = list_t<int, 78, 100, 42, 45, -17, 55, -87, 97>;

  using result_g = qsort_t< list, function_<greater_> >;
  using result_l = qsort_t< list, function_<less_> >;
