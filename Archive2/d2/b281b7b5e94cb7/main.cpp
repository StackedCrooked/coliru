...
struct ReturnRealOne{ //struct because its implicit public
   static int someFunctionReturning(){ //this is the implementation of the real function(s), to be added to REAL code
        return 1;
    }
};

struct ReturnFakeTwo{
   static int someFunctionReturning(){ //this is some fake implementation, to be added to TEST code only
        return 2;   
