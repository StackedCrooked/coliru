...
template<typename Function> //TODO: enable if Function::operator() ?
value vfunc(Function&& f)
{
	typedef typename function_traits<Function>::function function;
	return vfunc(static_cast<function>(f));
}
/////////////////////////////////////////////////////////////////////////////
