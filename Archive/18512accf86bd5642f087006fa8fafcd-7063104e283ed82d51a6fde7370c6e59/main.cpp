...
struct DisableIf {
    typedef typename std::enable_if<!C::value, T>::type type;
};
...
template<class... Ts, class U, class... Vs, typename std::enable_if<!std::is_same<U, disambiguator_t const&>::value, int>::type = 0>
