...
int main() {
    assert(generatePrimes<2>().empty());
    assert(generatePrimes<3>().back() == 2);
    assert(generatePrimes<4>().back() == 3);
    assert(generatePrimes<5>().back() == 3);
    assert(generatePrimes<6>().back() == 5);
    assert(generatePrimes<7>().back() == 5);
    assert(generatePrimes<8>().back() == 7);
